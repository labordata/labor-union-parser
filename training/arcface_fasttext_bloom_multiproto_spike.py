"""ArcFace with Multi-Prototype Support for CWA Number Aliases.

Based on arcface_fasttext_bloom_spike.py. CWA locals with 5-digit numbers
(IUE 81xxx, NABET 5xxxx, Guild 3xxxx, etc.) get a second prototype using
the short form of the number. "NABET-31" can match the alias prototype
with bloom(31) while "IUE-CWA-52031" matches the full prototype with bloom(52031).

Scores are aggregated via logsumexp over variants per class.
"""
